...
export const AWS_SERVICE_FACTS: Record<string, AWSServiceFact> = {
  ...
  S3: {
    service: "Amazon S3",
    iconPath: "/assets/aws-icons/Simple Storage Service.png",
  ...
  API_GATEWAY: {
    ...
    iconPath: "/assets/aws-icons/API Gateway.png",
  ...
  DYNAMODB: {
    ...
    iconPath: "/assets/aws-icons/DynamoDB.png",
  ...
  CLOUDFORMATION: {
    ...
    iconPath: "/assets/aws-icons/CloudFormation.png",
  ...
  EC2: {
    service: "Amazon EC2",
    iconPath: "/assets/aws-icons/EC2.png",
  ...
  CLOUDWATCH: {
    ...
    iconPath: "/assets/aws-icons/CloudWatch.png",
