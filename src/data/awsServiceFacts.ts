export interface AWSServiceFact {
  service: string;
  iconPath: string;  // Changed from icon to iconPath for SVG files
  fact: string;
  category: string;
  launchYear: number;
}
...
export const AWS_SERVICE_FACTS: Record<string, AWSServiceFact> = {
  LAMBDA: {
    service: "AWS Lambda",
    iconPath: "/assets/aws-icons/Lambda.svg",
  ...
  S3: {
    service: "Amazon S3",
    iconPath: "/assets/aws-icons/Simple Storage Service.svg",
  ...
  API_GATEWAY: {
    ...
    iconPath: "/assets/aws-icons/API Gateway.svg",
  ...
  DYNAMODB: {
    ...
    iconPath: "/assets/aws-icons/DynamoDB.svg",
  ...
  CLOUDFORMATION: {
    ...
    iconPath: "/assets/aws-icons/CloudFormation.svg",
  ...
  EC2: {
    service: "Amazon EC2",
    iconPath: "/assets/aws-icons/EC2.svg",
  ...
  CLOUDWATCH: {
    ...
    iconPath: "/assets/aws-icons/CloudWatch.svg",
